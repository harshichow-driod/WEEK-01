...
public class NumberChecker4{
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        if(compareArray(digits, reversed)) System.out.println("they are equal");
        else System.out.println("They are not equal");
        if(isPalindrome(digits)) System.out.println("It is Palindrome");
        else System.out.println("It is not a Palindrome");
        if(isDuck(digits)) System.out.println("It is a Duck Number");
